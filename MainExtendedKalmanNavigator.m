...
ERR_FILENAME = 'err_extended.bin';
RES_FILENAME = 'res_extended.bin';
...
%         scenarios{end+1} = @()...
%         ExtendedKalmanNavigator([PATH 'mnav.bin'], [PATH 'mimu.bin'], [dir 'mlidar.bin'], ...
%             [PATH 'meta.bin'], [dir RES_FILENAME], [dir ERR_FILENAME], [dir PRV_FILENAME], ...
%             DTM, Q, 1e-6, 1e-3, P, sim_len, show_only);
%     end
%     
