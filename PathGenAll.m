function success = PathGenAll( dir_name, mot_def, ini_pos, n_rays, span_angle, freq_Hz, DTM, cellsize )
    ...
    gen_ground_truth(dir_name, mot_def, ini_pos, freq_Hz);
...
function [] = gen_ground_truth(dir_name, mot_def, ini_pos, freq_Hz)
