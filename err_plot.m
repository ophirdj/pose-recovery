...
%         'C:\Users\Ophir\matlab_workspace\trajectories\circle1_20\', ...
%         'C:\Users\Ophir\matlab_workspace\trajectories\circle10\' ,...
%         'C:\Users\Ophir\matlab_workspace\trajectories\circle10_20\', ...
...
imu_mean(:,:,1) = imu_mean(:,:,1) ./ imu_legal;
imu_mean(:,:,2) = imu_mean(:,:,2) ./ imu_legal;
dtm_mean(:,1) = dtm_mean(:,1) ./ dtm_legal;
dtm_mean(:,2) = dtm_mean(:,2) ./ dtm_legal;
lidar_mean(:,1) = lidar_mean(:,1) ./ lidar_legal;
lidar_mean(:,2) = lidar_mean(:,2) ./ lidar_legal;
window_mean(:,1) = window_mean(:,1) ./ window_legal;
window_mean(:,2) = window_mean(:,2) ./ window_legal;
...
%Window
figure;
plot(flip(windows), window_mean(:,1));
% set(gca, 'xscale', 'log');
xlabel('Batch Size');
ylabel('Position error (m)');
...
figure;
plot(flip(windows), window_mean(:,2) * 1e3);
% set(gca, 'xscale', 'log');
xlabel('Batch Size');
ylabel('Rotation error (mrad)');
